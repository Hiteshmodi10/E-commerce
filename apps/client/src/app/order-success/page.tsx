...
export default function OrderSuccessPage() {
  ...
  useEffect(() => {
    ...
    if (lastOrder) {
      ...
      setOrderInfo(order);
      setOrderNumber(
        order.orderNumber || `ESH${Date.now().toString().slice(-6)}`
      );
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center py-16">
            ...
            <p className="text-xl text-gray-600 mb-8">
              We couldn't find your recent order information. This might happen
              if you refreshed the page.
            </p>
            <div className="space-y-4">
              <p className="text-gray-600">
                Don't worry! Your order has been placed successfully. You can
              ...
              <p className="text-sm text-gray-500 mt-4">
                You'll also receive an email confirmation with your order
                details.
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                We've sent you a confirmation email with order details and
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                You'll receive tracking information once your order ships. Track
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Your order will be delivered within 3-5 business days. Make sure
